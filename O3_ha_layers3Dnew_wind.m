...
O3_L2 = squeeze(O3(:,:,19,:)); % L2=850hPa
O3_L3 = squeeze(O3(:,:,23,:)); % L3=700hPa
O3_L4 = squeeze(O3(:,:,28,:)); % L4=500hPa
O3_L5 = squeeze(O3(:,:,32,:)); % L5=300hPa
...
% i=6;j=10;
        ...
        % shading flat
        % hold on
        % quiver3(lon_u(1:5:222,1:5:162),lat_u(1:5:222,1:5:162),z_wind_L3(1:5:222,1:5:162),...
        % uwind_L3(1:5:222,1:5:162,j,i),vwind_L3(1:5:222,1:5:162,j,i),z0(1:5:222,1:5:162),scale);
        % hold on
        % % layer4=500hPa
        ...
        % shading flat
        % hold on
        % quiver3(lon_u(1:5:222,1:5:162),lat_u(1:5:222,1:5:162),z_wind_L4(1:5:222,1:5:162),...
        % uwind_L4(1:5:222,1:5:162,j,i),vwind_L4(1:5:222,1:5:162,j,i),z0(1:5:222,1:5:162),scale);
        % hold on
        % % layer5=300hPa
        ...
        % shading flat
        % hold on
        % quiver3(lon_u(1:5:222,1:5:162),lat_u(1:5:222,1:5:162),z_wind_L5(1:5:222,1:5:162),...
        % uwind_L5(1:5:222,1:5:162,j,i),vwind_L5(1:5:222,1:5:162,j,i),z0(1:5:222,1:5:162),scale);
        % hold on
        ...
        set(gca,'ztick',[0:3:4],'zticklabel',[1000 850]);
        ...
        if (j>=1)&&(j<=16) 
            ...
            path = ['F:/Figure/CaseSG3/fig_add/O3_layer_wind/O3_','2021-03-',num2str(i+22-1),'-',num2str(hour(j))]; % Note here to modify
            ...
            path = ['F:/Figure/CaseSG3/fig_add/O3_layer_wind/O3_','2021-03-',num2str(i+22),'-',num2str(hour(j-16))]; % Note here to modify
            print(gcf,'-dtiff','-r600',path)
        end
    end
end
