...
for i=1:nDays
    for j=1:24
        ...
        if (j>=1)&&(j<=16) 
            ...
            path = ['D:/files/Master/02学术/Case/Shaog03/fig_slice/O3_','2021-03-',num2str(i+22-1),'-',num2str(hour(j))]; % Note here to modify
            ...
            path = ['D:/files/Master/02学术/Case/Shaog03/fig_slice/O3_','2021-03-',num2str(i+22),'-',num2str(hour(j-16))]; % Note here to modify
            print(gcf,'-dtiff','-r600',path)
        end
    end
end
