...
for i=4:5
    for j=1:24
        ...
        if (j>=1)&&(j<=2) 
            ...
            path = ['F:/Figure/caseSG3/fig_add/slice/','2021-03-',num2str(i+22-1),'-0',num2str(hour(j))]; % Note here to modify
        ...
        elseif (j>2)&&(j<=16)
            ...
            path = ['F:/Figure/caseSG3/fig_add/slice/','2021-03-',num2str(i+22-1),'-',num2str(hour(j))]; % Note here to modify
            print(gcf,'-dpng','-r600',path)
        else
            hour=[0:7];
            ...
            path = ['F:/Figure/caseSG3/fig_add/slice/','2021-03-',num2str(i+22),'-0',num2str(hour(j-16))]; % Note here to modify
            print(gcf,'-dpng','-r600',path)
        end
    end
end
