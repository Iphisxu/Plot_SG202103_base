...
for i=3:5
    for j=1:24
        ...
        if (j>=1)&&(j<=2) 
            ...
            path = ['D:/files/Master/02学术/Case/Shaog03/fig_slice4gif/O3_','2021-03-',num2str(i+22-1),'-0',num2str(hour(j))]; % Note here to modify
        ...
        elseif (j>=3)&&(j<=16)
            ...
            path = ['D:/files/Master/02学术/Case/Shaog03/fig_slice4gif/O3_','2021-03-',num2str(i+22-1),'-',num2str(hour(j))]; % Note here to modify
        else
            hour=[0:7];
            ...
            path = ['D:/files/Master/02学术/Case/Shaog03/fig_slice4gif/O3_','2021-03-',num2str(i+22),'-0',num2str(hour(j-16))]; % Note here to modify
            print(gcf,'-dpng','-r600',path)
        end
    end
end
