...
O3_obs=xlsread('F:/Data/Gaoshanzhan.xlsx','D26:D169');
...
hold on;
plot(t+8,squeeze(O3_L1(46,62,:)),'-xb');
plot(t+8,squeeze(O3_L2(46,62,:)),'-xg');
...
path = ['D:/files/Master/02学术/Case/Shaog03/fig_lines/O3_850hPa_simobs']; % Note here to modify
